...
LANGUAGES.PT = {
    ...
    text: {
        ...
        'all-research': {
            ...
            'm11': [`Auto-Melhoria da Mineração MK2`,`Auto-Melhoria de Mineração do ${toTextStyle('Tubarão','shark')} agora aplcia ao resto das melhorias de mineração do ${toTextStyle('Tubarãok','shark')}.`],
